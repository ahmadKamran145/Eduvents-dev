...
const EventsContent = () => {
  ...
  return (
    <Layout>
      ...
      <AdPluggZone zoneName="upper_banner" className="max-w-[1216px] mx-auto px-4 sm:px-6 lg:px-8 pt-3" />
      ...
      <AdPluggZone zoneName="content_ad" className="max-w-[1216px] mx-auto px-4 sm:px-6 lg:px-8 pb-3" />
