...
import { Event, SubjectArea, EventPhase } from "@/data/events";
  ...
  const handleStatusChange = async (
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.success(
          `Event ${statusText} successfully! Email notification sent to organiser.`,
        );
      }
    } catch (error) {
                  ...
                  <div className="space-y-4">
                    <div className="bg-warning/10 border border-warning/20 rounded-lg p-4">
                      <p className="text-sm text-warning font-medium">
                        ...
                        {pendingEvents.length !== 1 ? "s" : ""} awaiting review
                      </p>
                    </div>
